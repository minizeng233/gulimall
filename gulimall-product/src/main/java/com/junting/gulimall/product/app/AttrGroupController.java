...
public class AttrGroupController {
    ...
    public R getAttrByCategoryId(@PathVariable("catelogId") Long catelogId){
        List<AttrGroupWithAttrsVo> entities =  attrGroupService.getAttrGroupByCategoryId(catelogId);
